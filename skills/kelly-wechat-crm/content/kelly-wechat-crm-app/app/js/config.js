export const appConfig = {
  ...
  description:
    "个人微信关系管理台：从本机微信同步联系人和近期活跃度，标注关系与备注，把该跟进的联系人排进可审核的跟进队列——只读微信数据，从不代发消息。",
  locale: "zh",
  deployment: "desktop",
  spaceId: "local",
  readOnly: false,
    ...
    required_fields: [
      {
        ...
        unlocks: ["follow-up flagging in the sync task"],
      },
    ],
    completion_resource: "settings",
    rationale:
      "Only one tunable threshold; shipped pre-seeded via seed_records so onboarding completes on first sync without a setup wizard.",
  },
  brand: {
    mode: "inferred",
    accent: "#07C160",
    ...
    screens: [
      {
        ...
        data_sources: ["contacts", "followups", "settings"],
      },
      {
        id: "contacts",
        name: "联系人",
      ...
      },
      {
        ...
        data_sources: ["followups", "contacts"],
      },
    ],
    attention_states: ["needs-followup", "needs-review"],
    actions: [
      {
        id: "update-contact",
        label: "更新联系人标签/备注",
        kind: "change_request",
        base: "contacts",
        fields: ["tag", "relationship-note", "follow-up-status"],
      },
      {
        id: "decide-followup",
        label: "处理跟进建议",
  ...
  permissions: {
    read_procedures: ["records.list", "records.get", "changeRequests.list"],
    change_request_procedures: ["records.update"],
  },
  demoRecords: [
    {
      id: "demo-contacts-1",
